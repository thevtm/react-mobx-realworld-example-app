...
import {fetch as isoFetch} from 'whatwg-fetch'

import { Configuration } from "./configuration";

const BASE_PATH = "http://conduit.productionready.io/api".replace(/\/+$/, "");
...
export class BaseAPI {
    ...
    constructor(configuration?: Configuration, protected basePath: string = BASE_PATH, protected fetch: FetchAPI = isoFetch) {
        if (configuration) {
...
export const ArticlesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createArticle(article: NewArticleRequest, options: any = {}): FetchArgs {
            ...
            const needsSerialization = (<any>"NewArticleRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(article || {}) : (article || "");
         ...
         * @throws {RequiredError}
         */
        getArticles(tag?: string, author?: string, favorited?: string, limit?: number, offset?: number, options: any = {}): FetchArgs {
            const localVarPath = `/articles`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        getArticlesFeed(limit?: number, offset?: number, options: any = {}): FetchArgs {
        ...
        updateArticle(slug: string, article: UpdateArticleRequest, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"UpdateArticleRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(article || {}) : (article || "");
...
export const ArticlesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createArticle(article: NewArticleRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleArticleResponse> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).createArticle(article, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
         ...
         * @throws {RequiredError}
         */
        deleteArticle(slug: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).deleteArticle(slug, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
         ...
         * @throws {RequiredError}
         */
        getArticle(slug: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleArticleResponse> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).getArticle(slug, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getArticles(tag?: string, author?: string, favorited?: string, limit?: number, offset?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MultipleArticlesResponse> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).getArticles(tag, author, favorited, limit, offset, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getArticlesFeed(limit?: number, offset?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MultipleArticlesResponse> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).getArticlesFeed(limit, offset, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateArticle(slug: string, article: UpdateArticleRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleArticleResponse> {
            const localVarFetchArgs = ArticlesApiFetchParamCreator(configuration).updateArticle(slug, article, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ArticlesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        createArticle(article: NewArticleRequest, options?: any) {
            return ArticlesApiFp(configuration).createArticle(article, options)(fetch, basePath);
        },
        /**
         * Delete an article. Auth is required
         * @summary Delete an article
        ...
        deleteArticle(slug: string, options?: any) {
            return ArticlesApiFp(configuration).deleteArticle(slug, options)(fetch, basePath);
        },
        /**
         * Get an article. Auth not required
         * @summary Get an article
        ...
        getArticle(slug: string, options?: any) {
            return ArticlesApiFp(configuration).getArticle(slug, options)(fetch, basePath);
        },
        /**
         * Get most recent articles globally. Use query parameters to filter results. Auth is optional
         * @summary Get recent articles globally
        ...
        getArticles(tag?: string, author?: string, favorited?: string, limit?: number, offset?: number, options?: any) {
            return ArticlesApiFp(configuration).getArticles(tag, author, favorited, limit, offset, options)(fetch, basePath);
        },
        /**
         * Get most recent articles from users you follow. Use query parameters to limit. Auth is required
         * @summary Get recent articles from users you follow
        ...
        getArticlesFeed(limit?: number, offset?: number, options?: any) {
            return ArticlesApiFp(configuration).getArticlesFeed(limit, offset, options)(fetch, basePath);
        },
        /**
         * Update an article. Auth is required
         * @summary Update an article
        ...
        updateArticle(slug: string, article: UpdateArticleRequest, options?: any) {
            return ArticlesApiFp(configuration).updateArticle(slug, article, options)(fetch, basePath);
        },
    };
};
...
export class ArticlesApi extends BaseAPI {
    ...
    public createArticle(article: NewArticleRequest, options?: any) {
        return ArticlesApiFp(this.configuration).createArticle(article, options)(this.fetch, this.basePath);
    }
    ...
    public deleteArticle(slug: string, options?: any) {
        return ArticlesApiFp(this.configuration).deleteArticle(slug, options)(this.fetch, this.basePath);
    }
    ...
    public getArticle(slug: string, options?: any) {
        return ArticlesApiFp(this.configuration).getArticle(slug, options)(this.fetch, this.basePath);
    }
    ...
    public getArticles(tag?: string, author?: string, favorited?: string, limit?: number, offset?: number, options?: any) {
        return ArticlesApiFp(this.configuration).getArticles(tag, author, favorited, limit, offset, options)(this.fetch, this.basePath);
    }
    ...
    public getArticlesFeed(limit?: number, offset?: number, options?: any) {
        return ArticlesApiFp(this.configuration).getArticlesFeed(limit, offset, options)(this.fetch, this.basePath);
    }
    ...
    public updateArticle(slug: string, article: UpdateArticleRequest, options?: any) {
        return ArticlesApiFp(this.configuration).updateArticle(slug, article, options)(this.fetch, this.basePath);
    }
...
export const CommentsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createArticleComment(slug: string, comment: NewCommentRequest, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"NewCommentRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const CommentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createArticleComment(slug: string, comment: NewCommentRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleCommentResponse> {
            const localVarFetchArgs = CommentsApiFetchParamCreator(configuration).createArticleComment(slug, comment, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        deleteArticleComment(slug: string, id: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = CommentsApiFetchParamCreator(configuration).deleteArticleComment(slug, id, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
         ...
         * @throws {RequiredError}
         */
        getArticleComments(slug: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MultipleCommentsResponse> {
            const localVarFetchArgs = CommentsApiFetchParamCreator(configuration).getArticleComments(slug, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const CommentsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        createArticleComment(slug: string, comment: NewCommentRequest, options?: any) {
            return CommentsApiFp(configuration).createArticleComment(slug, comment, options)(fetch, basePath);
        },
        /**
         * Delete a comment for an article. Auth is required
         * @summary Delete a comment for an article
        ...
        deleteArticleComment(slug: string, id: number, options?: any) {
            return CommentsApiFp(configuration).deleteArticleComment(slug, id, options)(fetch, basePath);
        },
        /**
         * Get the comments for an article. Auth is optional
         * @summary Get comments for an article
        ...
        getArticleComments(slug: string, options?: any) {
            return CommentsApiFp(configuration).getArticleComments(slug, options)(fetch, basePath);
        },
    };
};
...
export class CommentsApi extends BaseAPI {
    ...
    public createArticleComment(slug: string, comment: NewCommentRequest, options?: any) {
        return CommentsApiFp(this.configuration).createArticleComment(slug, comment, options)(this.fetch, this.basePath);
    }
    ...
    public deleteArticleComment(slug: string, id: number, options?: any) {
        return CommentsApiFp(this.configuration).deleteArticleComment(slug, id, options)(this.fetch, this.basePath);
    }
    ...
    public getArticleComments(slug: string, options?: any) {
        return CommentsApiFp(this.configuration).getArticleComments(slug, options)(this.fetch, this.basePath);
    }
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        tagsGet(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<TagsResponse> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).tagsGet(options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export class DefaultApi extends BaseAPI {
    ...
    public tagsGet(options?: any) {
        return DefaultApiFp(this.configuration).tagsGet(options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const FavoritesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
export const FavoritesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createArticleFavorite(slug: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleArticleResponse> {
            const localVarFetchArgs = FavoritesApiFetchParamCreator(configuration).createArticleFavorite(slug, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        deleteArticleFavorite(slug: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SingleArticleResponse> {
            const localVarFetchArgs = FavoritesApiFetchParamCreator(configuration).deleteArticleFavorite(slug, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const FavoritesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Favorite an article. Auth is required
         * @summary Favorite an article
        ...
        createArticleFavorite(slug: string, options?: any) {
            return FavoritesApiFp(configuration).createArticleFavorite(slug, options)(fetch, basePath);
        },
        /**
         * Unfavorite an article. Auth is required
         * @summary Unfavorite an article
        ...
        deleteArticleFavorite(slug: string, options?: any) {
            return FavoritesApiFp(configuration).deleteArticleFavorite(slug, options)(fetch, basePath);
        },
    };
};
...
export class FavoritesApi extends BaseAPI {
    ...
    public createArticleFavorite(slug: string, options?: any) {
        return FavoritesApiFp(this.configuration).createArticleFavorite(slug, options)(this.fetch, this.basePath);
    }
    ...
    public deleteArticleFavorite(slug: string, options?: any) {
        return FavoritesApiFp(this.configuration).deleteArticleFavorite(slug, options)(this.fetch, this.basePath);
    }
...
export const ProfileApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        followUserByUsername(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ProfileResponse> {
            const localVarFetchArgs = ProfileApiFetchParamCreator(configuration).followUserByUsername(username, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getProfileByUsername(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ProfileResponse> {
            const localVarFetchArgs = ProfileApiFetchParamCreator(configuration).getProfileByUsername(username, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        unfollowUserByUsername(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ProfileResponse> {
            const localVarFetchArgs = ProfileApiFetchParamCreator(configuration).unfollowUserByUsername(username, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ProfileApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        followUserByUsername(username: string, options?: any) {
            return ProfileApiFp(configuration).followUserByUsername(username, options)(fetch, basePath);
        },
        /**
         * Get a profile of a user of the system. Auth is optional
         * @summary Get a profile
        ...
        getProfileByUsername(username: string, options?: any) {
            return ProfileApiFp(configuration).getProfileByUsername(username, options)(fetch, basePath);
        },
        /**
         * Unfollow a user by username
         * @summary Unfollow a user
        ...
        unfollowUserByUsername(username: string, options?: any) {
            return ProfileApiFp(configuration).unfollowUserByUsername(username, options)(fetch, basePath);
        },
    };
};
...
export class ProfileApi extends BaseAPI {
    ...
    public followUserByUsername(username: string, options?: any) {
        return ProfileApiFp(this.configuration).followUserByUsername(username, options)(this.fetch, this.basePath);
    }
    ...
    public getProfileByUsername(username: string, options?: any) {
        return ProfileApiFp(this.configuration).getProfileByUsername(username, options)(this.fetch, this.basePath);
    }
    ...
    public unfollowUserByUsername(username: string, options?: any) {
        return ProfileApiFp(this.configuration).unfollowUserByUsername(username, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const UserAndAuthenticationApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Register a new user
        ...
        login(body: LoginUserRequest, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"LoginUserRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(body || {}) : (body || "");
...
export const UserAndAuthenticationApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUser(body: NewUserRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UserResponse> {
            const localVarFetchArgs = UserAndAuthenticationApiFetchParamCreator(configuration).createUser(body, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getCurrentUser(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UserResponse> {
            const localVarFetchArgs = UserAndAuthenticationApiFetchParamCreator(configuration).getCurrentUser(options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        login(body: LoginUserRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UserResponse> {
            const localVarFetchArgs = UserAndAuthenticationApiFetchParamCreator(configuration).login(body, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateCurrentUser(body: UpdateUserRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UserResponse> {
            const localVarFetchArgs = UserAndAuthenticationApiFetchParamCreator(configuration).updateCurrentUser(body, options);
            return (fetch: FetchAPI = isoFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const UserAndAuthenticationApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Register a new user
         * @summary Register a new user
        ...
        createUser(body: NewUserRequest, options?: any) {
            return UserAndAuthenticationApiFp(configuration).createUser(body, options)(fetch, basePath);
        },
        /**
         * Gets the currently logged-in user
         * @summary Get current user
        ...
        getCurrentUser(options?: any) {
            return UserAndAuthenticationApiFp(configuration).getCurrentUser(options)(fetch, basePath);
        },
        /**
         * Login for existing user
         * @summary Existing user login
        ...
        login(body: LoginUserRequest, options?: any) {
            return UserAndAuthenticationApiFp(configuration).login(body, options)(fetch, basePath);
        },
        /**
         * Updated user information for current user
         * @summary Update current user
        ...
        updateCurrentUser(body: UpdateUserRequest, options?: any) {
            return UserAndAuthenticationApiFp(configuration).updateCurrentUser(body, options)(fetch, basePath);
        },
    };
};
...
export class UserAndAuthenticationApi extends BaseAPI {
    ...
    public createUser(body: NewUserRequest, options?: any) {
        return UserAndAuthenticationApiFp(this.configuration).createUser(body, options)(this.fetch, this.basePath);
    }
    ...
    public getCurrentUser(options?: any) {
        return UserAndAuthenticationApiFp(this.configuration).getCurrentUser(options)(this.fetch, this.basePath);
    }
    ...
    public login(body: LoginUserRequest, options?: any) {
        return UserAndAuthenticationApiFp(this.configuration).login(body, options)(this.fetch, this.basePath);
    }
    ...
    public updateCurrentUser(body: UpdateUserRequest, options?: any) {
        return UserAndAuthenticationApiFp(this.configuration).updateCurrentUser(body, options)(this.fetch, this.basePath);
    }
